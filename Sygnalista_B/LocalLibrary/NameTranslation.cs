...
public class NameTranslation
{
    ...
    public static async Task InitializeTurnoverMedian()
    {
        ...
        if (File.Exists("C:\\Users\\rafal\\Desktop\\Pogromcy\\Sygnalista_B\\TurnoverMedianTable"))
        {
            using StreamReader reader = new("C:\\Users\\rafal\\Desktop\\Pogromcy\\Sygnalista_B\\TurnoverMedianTable");
            string line;
    ...
    public static void InitializeTranslations()
    {
        ...
        {
            _ = MessageBox.Show($"Nie udało się zainicjować translacji, ponieważ: {ex.Message}");
        }
    }
